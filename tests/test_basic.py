...
def test_imports():
    ...
    from movedb.core import Trial, Event, Points, Analogs, ImportMethod
...
def test_trial_creation():
    ...
    from movedb import Points, Analogs, MarkerTrajectory, AnalogChannel
    import polars as pl
