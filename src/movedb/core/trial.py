...
from .time_series import Points, Analogs
...
class Trial(BaseModel):
    ...
    def from_c3d(cls: Type[_T], 
        ...
        trial_data = C3DLoader.load_from_c3d_object(c3d_object, trial_name, session_name, classification)
    ...
    def export_force_platforms(self, output_dir: str, applied_bodies: dict[int, str], **kwargs):
