...
from ..core import (
    Event, Points, Analogs, MarkerTrajectory, AnalogChannel, 
    EZC3DForcePlatform, ImportMethod
)
...
class C3DLoader:
    ...
    @classmethod
    def load_from_c3d_object(cls, c3d_object: ezc3d.c3d, trial_name: str = "", 
                           session_name: str = "", classification: str = "") -> dict:
        """
    ...
    def load_from_file(cls, file_path: str) -> dict:
        ...
        trial_data = cls.load_from_c3d_object(c3d_object, trial_name=trial_name, 
                                            session_name=session_name, classification=classification)
